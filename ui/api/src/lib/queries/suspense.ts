...
export const useDefaultServiceTasksControllerGetTasksSuspense = <TData = Common.DefaultServiceTasksControllerGetTasksDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseDefaultServiceTasksControllerGetTasksKeyFn(queryKey), queryFn: () => DefaultService.tasksControllerGetTasks() as TData, ...options });
